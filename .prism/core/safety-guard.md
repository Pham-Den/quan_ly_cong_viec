...
Do not apply this guard to project artifacts outside `.prism/`, such as `docs/sprint-v{X}/**`, `docs/inbox/**`, the live project-root `prism-config.md`, or user-owned project notes like `docs/product-backlog.md`.
