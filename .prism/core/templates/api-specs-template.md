...
| Khía cạnh | Nội dung |
|---|---|
| **Assumption** | <!-- Giả định về auth model, versioning strategy. VD: "Dùng Bearer JWT, single version /api/v1. Nếu cần v2 → new sprint + breaking change." --> |
| **Validate** | <!-- Ai xác nhận? --> |
