...
- **Role**: <!-- Chức vụ, công ty, industry. VD: "Senior Accountant tại SME 50–200 nhân viên, ngành bán lẻ".
  B2B: phân biệt NGƯỜI MUA (ký hợp đồng, quan tâm ROI/giá) và NGƯỜI DÙNG hằng ngày — nếu là hai người khác nhau, tách thành persona riêng. -->

- **Segment size** *(optional)*: <!-- Quy mô nhóm này — bao nhiêu người / tỷ lệ trong tổng user (từ câu hỏi "bao nhiêu user?" ở interrogation). VD: "~40 kế toán / 200 nhân viên; 1 manager quản 8–10 nhân viên". Ghi `—` nếu chưa có số. -->
...
- [ ] Primary và secondary personas phân biệt rõ ràng; có ít nhất 1 persona `Priority = Primary` trong bảng §1
- [ ] B2B (nếu áp dụng): người mua và người dùng hằng ngày là hai persona riêng khi họ khác nhau; Segment size ghi số hoặc `—`
