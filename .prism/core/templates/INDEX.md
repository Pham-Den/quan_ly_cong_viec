...
| Bug | Bug Report | `bug-report-template.md` | _(sprint-independent registry `docs/bugs/`, không promote)_ | `BUG-NNN` |

**Total**: 23 templates. **15 root Living Truth files** + N dynamic epic files (1 per epic under `/docs/product/epics/`).
