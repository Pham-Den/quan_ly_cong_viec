...
Thiết kế logic **BẮT BUỘC** dùng **C4 Model** với **tối thiểu 3 cấp**: C1 System Context, C2 Container, và C3 Component (cấp C4 Code là tuỳ chọn, chỉ thêm khi thực sự cần). Mô hình phải thể hiện các layers kiến trúc.
