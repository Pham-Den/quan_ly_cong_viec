...
description: >
  Prepare a complete Sprint Review demo script: compile completed user stories,
  design the demo flow, prepare data, assign presenters, and create an environment checklist.
  Trigger: demo, prepare demo, demo script, sprint demo, sprint review.
  Output: Demo Script Markdown + Pre-demo Checklist.
---
