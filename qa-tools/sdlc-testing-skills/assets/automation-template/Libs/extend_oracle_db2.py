...
_instances = []
@library
class ExtendOracleDB2:
    """Library for querying Oracle databases - secondary instance (DEV, UAT, QC)"""
    ROBOT_LIBRARY_SCOPE = "TEST CASE"
    
    HOST = os.environ.get("ORACLE_HOST", "your-oracle.example.com")
    PORT = int(os.environ.get("ORACLE_PORT", "1521"))
    SERVICE_NAME = os.environ.get("ORACLE_SERVICE", "your-oracle-service")

    def __init__(self) -> None:
        logger.debug("Initializing ExtendOracleDB2")
    ...
    @keyword('Oracle DB2 Query Master')
    def oracle_db2_query_master(self, sql_query: str) -> str:
        """
    ...
    @keyword('Oracle DB2 Query Customer')
    def oracle_db2_query_customer(self, sql_query: str) -> str:
        """
    ...
    @keyword('Oracle DB2 Query Transaction')
    def oracle_db2_query_transaction(self, sql_query: str) -> str:
        """
    ...
    @keyword('Oracle DB2 Query Log')
    def oracle_db2_query_log(self, sql_query: str) -> str:
        """
    ...
    @keyword('Oracle DB2 Query Core')
    def oracle_db2_query_core(self, sql_query: str) -> str:
        """
...
#     ca = tt.oracle_db2_query_log(sql_query)
#     print("========================")
#     print(ca)
