...
data = {
    # Passwords loaded from env — set CDP_PASSWORD_DEV / CDP_PASSWORD_QC in your environment
    "omd_cdp_ingest_workers_dev": os.environ.get("CDP_PASSWORD_DEV", "<YOUR_CDP_PASSWORD>"),
    "omd_cdp_ingest_workers_qc": os.environ.get("CDP_PASSWORD_QC", "<YOUR_CDP_PASSWORD>"),
}
...
class extend_cdp:
    ...
    def cdp_query_database(self, db_name: str, sql_query: str) -> str:
        ...
        db_config = {
            ...
            'host': os.environ.get("TIDB_HOST", "your-tidb.example.com"),
            'port': 4000,
