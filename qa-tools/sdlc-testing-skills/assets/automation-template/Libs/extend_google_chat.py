...
# run = google_chat().google_send_text("<YOUR_CHAT_ID>","http://your-ci.example.com:8080/job/YOUR-PROJECT/1/")
# run1 = google_chat().google_send_card(suitename="YourSuite", messages="23 tests, 1 passed, 0 failed", env="qc", url_pipeline="1234")
