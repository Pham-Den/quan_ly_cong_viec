...
URL_DREMIO = environ.get("DREMIO_URL", "https://your-dremio.example.com/")
...
class dremio_api(object):
    ...
    def config_db_dremio(self, env, db_name):
        context_dremio = {
            ...
            f"your_app_tracking": f"dp.your_app.semantic.event_tracking",
            f"me_dev": f"dp.your_app.application.dbt_dremio.me"
            }
    ...
    def Get_results_any_database(self, db_name, sql_cmd):
        ...
        Arguments:
        - ``DOC``: https://your-wiki.example.com/query-database-using-dremio-api
        ...
        - ``Return JSON data ``
        - ``Trường hợp thêm DB mới trong dremio vui long liên hệ your-team để thêm trong script ``
        """
