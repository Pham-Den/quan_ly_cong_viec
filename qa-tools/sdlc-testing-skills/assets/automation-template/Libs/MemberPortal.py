...
#     """
#     url = f"{url}"
#     # url = f"https://your-member-portal-{env}.example.com/api/bff-common/upload-multiple-files"
#     headers = {
#         "Accept": "application/json, text/plain, */*",
#         "Authorization": f"Bearer {token}"
#     }
...
def ops_portal_upload_file(url, file_path: str, token: str, member_code: str):
    ...
    Returns:
        str | None: Giá trị 'code' của file được upload, hoặc None nếu thất bại.
    """
    # url = f"https://your-ops-portal-{env}.example.com/api/bff-common/v2/upload-multiple-files?memberCode=<YOUR_MEMBER_CODE>"
