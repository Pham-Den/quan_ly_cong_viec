...
bootstrap_servers = ['your-kafka-tw-1.example.com:9093', 'your-kafka-tw-2.example.com:9093', 'your-kafka-tw-3.example.com:9093',
        'your-kafka-sg-4.example.com:9093', 'your-kafka-sg-5.example.com:9093', 'your-kafka-sg-6.example.com:9093']
...
class Kafka_Lib(object):
    ...
    Library | Kafka_Lib | your-kafka-clients-cert.pem | your-kafka-clients-key.pem |
